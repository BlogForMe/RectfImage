...
//        super.onDraw(canvas);  这个要注释否则就会没效果
        ...
        if (null == bitmap || bitmap.isRecycled()) {
            ...
            if (drawable != null) {
                ...
                mPaint.setXfermode(Xfermodes.sModes[6]);  //  取两层绘制交集。显示下层。
                //绘制圆角矩形
...
//            super.onDraw(canvas);
    ...
    private Bitmap getBitmap() {
        Bitmap bitamp = Bitmap.createBitmap(getWidth(), getHeight(), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(bitamp);
